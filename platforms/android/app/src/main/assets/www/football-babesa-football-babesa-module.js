(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["football-babesa-football-babesa-module"],{

/***/ "./src/app/football-babesa/football-babesa.module.ts":
/*!***********************************************************!*\
  !*** ./src/app/football-babesa/football-babesa.module.ts ***!
  \***********************************************************/
/*! exports provided: FootballBabesaPageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FootballBabesaPageModule", function() { return FootballBabesaPageModule; });
...
/* harmony import */ var _football_babesa_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./football-babesa.page */ "./src/app/football-babesa/football-babesa.page.ts");
...
var routes = [
    {
        path: '',
        component: _football_babesa_page__WEBPACK_IMPORTED_MODULE_5__["FootballBabesaPage"]
    }
];
var FootballBabesaPageModule = /** @class */ (function () {
    function FootballBabesaPageModule() {
    }
    FootballBabesaPageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_football_babesa_page__WEBPACK_IMPORTED_MODULE_5__["FootballBabesaPage"]]
        })
    ], FootballBabesaPageModule);
    return FootballBabesaPageModule;
}());
...
/***/ "./src/app/football-babesa/football-babesa.page.html":
/*!***********************************************************!*\
  !*** ./src/app/football-babesa/football-babesa.page.html ***!
  \***********************************************************/
...
/***/ "./src/app/football-babesa/football-babesa.page.ts":
/*!*********************************************************!*\
  !*** ./src/app/football-babesa/football-babesa.page.ts ***!
  \*********************************************************/
/*! exports provided: FootballBabesaPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FootballBabesaPage", function() { return FootballBabesaPage; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var FootballBabesaPage = /** @class */ (function () {
    function FootballBabesaPage(fs, menu, navCtrl, callNumber, alertController) {
        this.fs = fs;
        this.menu = menu;
    ...
    FootballBabesaPage.prototype.ngOnInit = function () {
    };
    FootballBabesaPage.prototype.openMenu = function () {
        this.menu.toggle('myMenu');
    };
    FootballBabesaPage.prototype.getDay = function () {
    ...
    FootballBabesaPage.prototype.showChangFutsalMon = function () {
    ...
    FootballBabesaPage.prototype.showChangFutsalTues = function () {
        this.checkRegisterStatus();
        this.changFutsalMon_var = false;
        this.changFutsalWed_var = false;
        this.changFutsalThu_var = false;
    ...
    FootballBabesaPage.prototype.showChangFutsalWed = function () {
        this.checkRegisterStatus();
        this.changFutsalMon_var = false;
        this.changFutsalTues_var = false;
        this.changFutsalThu_var = false;
    ...
    FootballBabesaPage.prototype.showChangFutsalThu = function () {
        this.checkRegisterStatus();
        this.changFutsalMon_var = false;
        this.changFutsalTues_var = false;
        this.changFutsalWed_var = false;
    ...
    FootballBabesaPage.prototype.showChangFutsalFri = function () {
        this.checkRegisterStatus();
        this.changFutsalMon_var = false;
        this.changFutsalTues_var = false;
        this.changFutsalWed_var = false;
    ...
    FootballBabesaPage.prototype.showChangFutsalSat = function () {
        this.checkRegisterStatus();
        this.changFutsalMon_var = false;
        this.changFutsalTues_var = false;
        this.changFutsalWed_var = false;
    ...
    FootballBabesaPage.prototype.showChangFutsalSun = function () {
        this.checkRegisterStatus();
        this.changFutsalMon_var = false;
        this.changFutsalTues_var = false;
        this.changFutsalWed_var = false;
    ...
    FootballBabesaPage.prototype.loadFromFirestoreFutsalMonday = function () {
        var _this = this;
        this.fs.collection('/football').doc('babesa').collection('/monday').get().subscribe(function (res) {
    ...
    FootballBabesaPage.prototype.loadFromFirestoreFutsalTuesday = function () {
        var _this = this;
        this.fs.collection('/football').doc('babesa').collection('/tuesday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FootballBabesaPage.prototype.loadFromFirestoreFutsalWednesday = function () {
        var _this = this;
        this.fs.collection('/football').doc('babesa').collection('/wednesday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FootballBabesaPage.prototype.loadFromFirestoreFutsalThursday = function () {
        var _this = this;
        this.fs.collection('/football').doc('babesa').collection('/thursday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FootballBabesaPage.prototype.loadFromFirestoreFutsalFriday = function () {
        var _this = this;
        this.fs.collection('/football').doc('babesa').collection('/friday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FootballBabesaPage.prototype.loadFromFirestoreFutsalSaturday = function () {
        var _this = this;
        this.fs.collection('/football').doc('babesa').collection('/saturday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FootballBabesaPage.prototype.loadFromFirestoreFutsalSunday = function () {
        var _this = this;
        this.fs.collection('/football').doc('babesa').collection('/sunday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FootballBabesaPage.prototype.loadPriceDetail = function () {
        var _this = this;
        this.fs.collection('/football').doc('babesa').get().subscribe(function (res) {
    ...
    FootballBabesaPage.prototype.callChang = function () {
        this.callNumber.callNumber(this.contact_no.toString(), true);
    };
    FootballBabesaPage.prototype.checkRegisterStatus = function () {
        console.log("Here ");
    ...
    FootballBabesaPage.prototype.presentAlert = function () {
    ...
    FootballBabesaPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-football-babesa',
            template: __webpack_require__(/*! ./football-babesa.page.html */ "./src/app/football-babesa/football-babesa.page.html"),
            styles: [__webpack_require__(/*! ./football-babesa.page.scss */ "./src/app/football-babesa/football-babesa.page.scss")],
        }),
...
//# sourceMappingURL=football-babesa-football-babesa-module.js.map