(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["movieadmin-movieadmin-module"],{

/***/ "./src/app/movieadmin/movieadmin.module.ts":
/*!*************************************************!*\
  !*** ./src/app/movieadmin/movieadmin.module.ts ***!
  \*************************************************/
/*! exports provided: MovieadminPageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MovieadminPageModule", function() { return MovieadminPageModule; });
...
/* harmony import */ var _movieadmin_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./movieadmin.page */ "./src/app/movieadmin/movieadmin.page.ts");
...
var routes = [
    {
        path: '',
        component: _movieadmin_page__WEBPACK_IMPORTED_MODULE_5__["MovieadminPage"]
    }
];
var MovieadminPageModule = /** @class */ (function () {
    function MovieadminPageModule() {
    }
    MovieadminPageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_movieadmin_page__WEBPACK_IMPORTED_MODULE_5__["MovieadminPage"]]
        })
    ], MovieadminPageModule);
    return MovieadminPageModule;
}());
...
/***/ "./src/app/movieadmin/movieadmin.page.html":
/*!*************************************************!*\
  !*** ./src/app/movieadmin/movieadmin.page.html ***!
  \*************************************************/
...
/***/ "./src/app/movieadmin/movieadmin.page.scss":
/*!*************************************************!*\
  !*** ./src/app/movieadmin/movieadmin.page.scss ***!
  \*************************************************/
/*! no static exports found */
...
/***/ "./src/app/movieadmin/movieadmin.page.ts":
/*!***********************************************!*\
  !*** ./src/app/movieadmin/movieadmin.page.ts ***!
  \***********************************************/
/*! exports provided: MovieadminPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MovieadminPage", function() { return MovieadminPage; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var MovieadminPage = /** @class */ (function () {
    function MovieadminPage(fs, altCtl, navCtl, fstorage, datePicker, uploadServ, menu, loadingController, firebase) {
        var _this = this;
        this.fs = fs;
        this.altCtl = altCtl;
        this.navCtl = navCtl;
        ...
        this.fs.collection('/movies', function (ref) { return ref.orderBy('createdAt', 'desc'); }).get().subscribe(function (res) {
            res.forEach(function (doc) {
                ...
                console.log("movie data: " + _this.movie);
                if (_this.movie) {
                    console.log("up");
    ...
    MovieadminPage.prototype.ngOnInit = function () {
    };
    MovieadminPage.prototype.openMenu = function () {
        this.menu.toggle('myMenu');
    };
    MovieadminPage.prototype.alert = function (header, message) {
    ...
    MovieadminPage.prototype.pickDate = function () {
        var _this = this;
    ...
    MovieadminPage.prototype.pickEndDate = function () {
        var _this = this;
        this.datePicker.show({
            date: new Date(),
            mode: 'date',
    ...
    MovieadminPage.prototype.goAddMore = function () {
        this.navCtl.navigateForward('/movieaddmore');
    };
    //for deleting the movie item
    MovieadminPage.prototype.goDelete = function (movietitle, name) {
        this.presentAlertConfirm(movietitle, name);
    };
    MovieadminPage.prototype.deleteSure = function (movietitle, name) {
        var _this = this;
        var basePath = "/movies";
        this.fs.collection("" + basePath).doc("" + movietitle).delete().then(function (data) {
    ...
    MovieadminPage.prototype.goEdit = function (movietitle) {
        console.log(movietitle);
        this.navCtl.navigateForward('/movieupdate/' + movietitle);
    };
    MovieadminPage.prototype.presentAlertConfirm = function (movietitle, name) {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return __generator(this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function () {
                                        ...
                                        _this.deleteSure(movietitle, name);
                                    }
                                }
                            ]
                        })];
    ...
    MovieadminPage.prototype.presentLoading = function () {
        return __awaiter(this, void 0, void 0, function () {
            var loading;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    MovieadminPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-movieadmin',
            template: __webpack_require__(/*! ./movieadmin.page.html */ "./src/app/movieadmin/movieadmin.page.html"),
            styles: [__webpack_require__(/*! ./movieadmin.page.scss */ "./src/app/movieadmin/movieadmin.page.scss")],
        }),
...
//# sourceMappingURL=movieadmin-movieadmin-module.js.map