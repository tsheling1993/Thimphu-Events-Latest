(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["football-serbithang-football-serbithang-module"],{

/***/ "./src/app/football-serbithang/football-serbithang.module.ts":
/*!*******************************************************************!*\
  !*** ./src/app/football-serbithang/football-serbithang.module.ts ***!
  \*******************************************************************/
/*! exports provided: FootballSerbithangPageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FootballSerbithangPageModule", function() { return FootballSerbithangPageModule; });
...
/* harmony import */ var _football_serbithang_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./football-serbithang.page */ "./src/app/football-serbithang/football-serbithang.page.ts");
...
var routes = [
    {
        path: '',
        component: _football_serbithang_page__WEBPACK_IMPORTED_MODULE_5__["FootballSerbithangPage"]
    }
];
var FootballSerbithangPageModule = /** @class */ (function () {
    function FootballSerbithangPageModule() {
    }
    FootballSerbithangPageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_football_serbithang_page__WEBPACK_IMPORTED_MODULE_5__["FootballSerbithangPage"]]
        })
    ], FootballSerbithangPageModule);
    return FootballSerbithangPageModule;
}());
...
/***/ "./src/app/football-serbithang/football-serbithang.page.html":
/*!*******************************************************************!*\
  !*** ./src/app/football-serbithang/football-serbithang.page.html ***!
  \*******************************************************************/
...
/***/ "./src/app/football-serbithang/football-serbithang.page.ts":
/*!*****************************************************************!*\
  !*** ./src/app/football-serbithang/football-serbithang.page.ts ***!
  \*****************************************************************/
/*! exports provided: FootballSerbithangPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FootballSerbithangPage", function() { return FootballSerbithangPage; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var FootballSerbithangPage = /** @class */ (function () {
    function FootballSerbithangPage(fs, menu, navCtrl, callNumber, alertController) {
        this.fs = fs;
        this.menu = menu;
    ...
    FootballSerbithangPage.prototype.getDay = function () {
    ...
    FootballSerbithangPage.prototype.ngOnInit = function () {
    };
    FootballSerbithangPage.prototype.openMenu = function () {
        this.menu.toggle('myMenu');
    };
    FootballSerbithangPage.prototype.showChangFullMon = function () {
    ...
    FootballSerbithangPage.prototype.showChangFullTues = function () {
        this.checkRegisterStatus();
        this.changFootballMon_var = false;
        this.changFootballWed_var = false;
        this.changFootballThu_var = false;
    ...
    FootballSerbithangPage.prototype.showChangFullWed = function () {
    ...
    FootballSerbithangPage.prototype.showChangFullThu = function () {
        this.checkRegisterStatus();
    ...
    FootballSerbithangPage.prototype.showChangFullFri = function () {
        this.checkRegisterStatus();
        console.log("friday");
        this.changFootballMon_var = false;
        this.changFootballTues_var = false;
    ...
    FootballSerbithangPage.prototype.showChangFullSat = function () {
        this.checkRegisterStatus();
    ...
    FootballSerbithangPage.prototype.showChangFullSun = function () {
        this.checkRegisterStatus();
        console.log("sunday");
        this.changFootballMon_var = false;
        this.changFootballTues_var = false;
    ...
    FootballSerbithangPage.prototype.loadFromFirestoreMonday = function () {
        var _this = this;
        this.fs.collection('/football').doc('serbithang').collection('/monday').get().subscribe(function (res) {
    ...
    FootballSerbithangPage.prototype.loadFromFirestoreTuesday = function () {
        var _this = this;
        this.fs.collection('/football').doc('serbithang').collection('/tuesday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FootballSerbithangPage.prototype.loadFromFirestoreWednesday = function () {
        var _this = this;
        this.fs.collection('/football').doc('serbithang').collection('/wednesday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FootballSerbithangPage.prototype.loadFromFirestoreThursday = function () {
        var _this = this;
        this.fs.collection('/football').doc('serbithang').collection('/thursday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FootballSerbithangPage.prototype.loadFromFirestoreFriday = function () {
        var _this = this;
        this.fs.collection('/football').doc('serbithang').collection('/friday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FootballSerbithangPage.prototype.loadFromFirestoreSaturday = function () {
        var _this = this;
        this.fs.collection('/football').doc('serbithang').collection('/saturday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FootballSerbithangPage.prototype.loadFromFirestoreSunday = function () {
        var _this = this;
        this.fs.collection('/football').doc('serbithang').collection('/sunday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FootballSerbithangPage.prototype.loadPriceDetail = function () {
        var _this = this;
        this.fs.collection('/football').doc('serbithang').get().subscribe(function (res) {
    ...
    FootballSerbithangPage.prototype.callChang = function () {
        this.callNumber.callNumber(this.contact_no.toString(), true);
    };
    FootballSerbithangPage.prototype.checkRegisterStatus = function () {
        console.log("Here ");
    ...
    FootballSerbithangPage.prototype.presentAlert = function () {
    ...
    FootballSerbithangPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-football-serbithang',
            template: __webpack_require__(/*! ./football-serbithang.page.html */ "./src/app/football-serbithang/football-serbithang.page.html"),
            styles: [__webpack_require__(/*! ./football-serbithang.page.scss */ "./src/app/football-serbithang/football-serbithang.page.scss")],
        }),
    ...
    ], FootballSerbithangPage);
    return FootballSerbithangPage;
}());
...
//# sourceMappingURL=football-serbithang-football-serbithang-module.js.map