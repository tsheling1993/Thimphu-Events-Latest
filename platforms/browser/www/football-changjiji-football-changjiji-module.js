(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["football-changjiji-football-changjiji-module"],{

/***/ "./src/app/football-changjiji/football-changjiji.module.ts":
/*!*****************************************************************!*\
  !*** ./src/app/football-changjiji/football-changjiji.module.ts ***!
  \*****************************************************************/
/*! exports provided: FootballChangjijiPageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FootballChangjijiPageModule", function() { return FootballChangjijiPageModule; });
...
/* harmony import */ var _football_changjiji_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./football-changjiji.page */ "./src/app/football-changjiji/football-changjiji.page.ts");
...
var routes = [
    {
        path: '',
        component: _football_changjiji_page__WEBPACK_IMPORTED_MODULE_5__["FootballChangjijiPage"]
    }
];
var FootballChangjijiPageModule = /** @class */ (function () {
    function FootballChangjijiPageModule() {
    }
    FootballChangjijiPageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_football_changjiji_page__WEBPACK_IMPORTED_MODULE_5__["FootballChangjijiPage"]]
        })
    ], FootballChangjijiPageModule);
    return FootballChangjijiPageModule;
}());
...
/***/ "./src/app/football-changjiji/football-changjiji.page.html":
/*!*****************************************************************!*\
  !*** ./src/app/football-changjiji/football-changjiji.page.html ***!
  \*****************************************************************/
...
/***/ "./src/app/football-changjiji/football-changjiji.page.ts":
/*!***************************************************************!*\
  !*** ./src/app/football-changjiji/football-changjiji.page.ts ***!
  \***************************************************************/
/*! exports provided: FootballChangjijiPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FootballChangjijiPage", function() { return FootballChangjijiPage; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var FootballChangjijiPage = /** @class */ (function () {
    function FootballChangjijiPage(fs, menu, navCtrl, callNumber, alertController) {
        this.fs = fs;
        this.menu = menu;
    ...
    FootballChangjijiPage.prototype.getDay = function () {
    ...
    FootballChangjijiPage.prototype.ngOnInit = function () {
    };
    FootballChangjijiPage.prototype.openMenu = function () {
        this.menu.toggle('myMenu');
    };
    FootballChangjijiPage.prototype.showChangFullMon = function () {
    ...
    FootballChangjijiPage.prototype.showChangFullTues = function () {
        this.checkRegisterStatus();
        this.changFootballMon_var = false;
        this.changFootballWed_var = false;
        this.changFootballThu_var = false;
    ...
    FootballChangjijiPage.prototype.showChangFullWed = function () {
        this.checkRegisterStatus();
    ...
    FootballChangjijiPage.prototype.showChangFullThu = function () {
        this.checkRegisterStatus();
    ...
    FootballChangjijiPage.prototype.showChangFullFri = function () {
        this.checkRegisterStatus();
        console.log("friday");
        this.changFootballMon_var = false;
        this.changFootballTues_var = false;
    ...
    FootballChangjijiPage.prototype.showChangFullSat = function () {
        this.checkRegisterStatus();
    ...
    FootballChangjijiPage.prototype.showChangFullSun = function () {
        this.checkRegisterStatus();
        console.log("sunday");
        this.changFootballMon_var = false;
        this.changFootballTues_var = false;
    ...
    FootballChangjijiPage.prototype.loadFromFirestoreMonday = function () {
        var _this = this;
        this.fs.collection('/football').doc('changjiji_full').collection('/monday').get().subscribe(function (res) {
    ...
    FootballChangjijiPage.prototype.loadFromFirestoreTuesday = function () {
        var _this = this;
        this.fs.collection('/football').doc('changjiji_full').collection('/tuesday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FootballChangjijiPage.prototype.loadFromFirestoreWednesday = function () {
        var _this = this;
        this.fs.collection('/football').doc('changjiji_full').collection('/wednesday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FootballChangjijiPage.prototype.loadFromFirestoreThursday = function () {
        var _this = this;
        this.fs.collection('/football').doc('changjiji_full').collection('/thursday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FootballChangjijiPage.prototype.loadFromFirestoreFriday = function () {
        var _this = this;
        this.fs.collection('/football').doc('changjiji_full').collection('/friday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FootballChangjijiPage.prototype.loadFromFirestoreSaturday = function () {
        var _this = this;
        this.fs.collection('/football').doc('changjiji_full').collection('/saturday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FootballChangjijiPage.prototype.loadFromFirestoreSunday = function () {
        var _this = this;
        this.fs.collection('/football').doc('changjiji_full').collection('/sunday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FootballChangjijiPage.prototype.loadPriceDetail = function () {
        var _this = this;
        this.fs.collection('/football').doc('changjiji_full').get().subscribe(function (res) {
    ...
    FootballChangjijiPage.prototype.callChang = function () {
        this.callNumber.callNumber(this.contact_no.toString(), true);
    };
    FootballChangjijiPage.prototype.checkRegisterStatus = function () {
        console.log("Here ");
    ...
    FootballChangjijiPage.prototype.presentAlert = function () {
    ...
    FootballChangjijiPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-football-changjiji',
            template: __webpack_require__(/*! ./football-changjiji.page.html */ "./src/app/football-changjiji/football-changjiji.page.html"),
            styles: [__webpack_require__(/*! ./football-changjiji.page.scss */ "./src/app/football-changjiji/football-changjiji.page.scss")],
        }),
    ...
    ], FootballChangjijiPage);
    return FootballChangjijiPage;
}());
...
//# sourceMappingURL=football-changjiji-football-changjiji-module.js.map