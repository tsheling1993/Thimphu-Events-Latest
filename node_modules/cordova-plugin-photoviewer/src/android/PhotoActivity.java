...
public class PhotoActivity extends Activity {
    ...
    protected void onResume() {
        if(getRequestedOrientation()!= ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE && isLandscape){
            setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
        }
        if(getRequestedOrientation()!= ActivityInfo.SCREEN_ORIENTATION_PORTRAIT && isPortrait){
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(getApplication().getResources().getIdentifier("photo", "layout", getApplication().getPackageName()));
		...
		try {
			...
			isLandscape = options.getBoolean("isLandscape");
			isPortrait = options.getBoolean("isPortrait");
