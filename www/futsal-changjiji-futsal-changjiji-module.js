(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["futsal-changjiji-futsal-changjiji-module"],{

/***/ "./src/app/futsal-changjiji/futsal-changjiji.module.ts":
/*!*************************************************************!*\
  !*** ./src/app/futsal-changjiji/futsal-changjiji.module.ts ***!
  \*************************************************************/
/*! exports provided: FutsalChangjijiPageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FutsalChangjijiPageModule", function() { return FutsalChangjijiPageModule; });
...
/* harmony import */ var _futsal_changjiji_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./futsal-changjiji.page */ "./src/app/futsal-changjiji/futsal-changjiji.page.ts");
...
var routes = [
    {
        path: '',
        component: _futsal_changjiji_page__WEBPACK_IMPORTED_MODULE_5__["FutsalChangjijiPage"]
    }
];
var FutsalChangjijiPageModule = /** @class */ (function () {
    function FutsalChangjijiPageModule() {
    }
    FutsalChangjijiPageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_futsal_changjiji_page__WEBPACK_IMPORTED_MODULE_5__["FutsalChangjijiPage"]]
        })
    ], FutsalChangjijiPageModule);
    return FutsalChangjijiPageModule;
}());
...
/***/ "./src/app/futsal-changjiji/futsal-changjiji.page.html":
/*!*************************************************************!*\
  !*** ./src/app/futsal-changjiji/futsal-changjiji.page.html ***!
  \*************************************************************/
...
/***/ "./src/app/futsal-changjiji/futsal-changjiji.page.ts":
/*!***********************************************************!*\
  !*** ./src/app/futsal-changjiji/futsal-changjiji.page.ts ***!
  \***********************************************************/
/*! exports provided: FutsalChangjijiPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FutsalChangjijiPage", function() { return FutsalChangjijiPage; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var FutsalChangjijiPage = /** @class */ (function () {
    function FutsalChangjijiPage(fs, menu, navCtrl, callNumber, alertController) {
        this.fs = fs;
        this.menu = menu;
    ...
    FutsalChangjijiPage.prototype.ngOnInit = function () {
    };
    FutsalChangjijiPage.prototype.openMenu = function () {
        this.menu.toggle('myMenu');
    };
    FutsalChangjijiPage.prototype.getDay = function () {
    ...
    FutsalChangjijiPage.prototype.showChangFutsalMon = function () {
    ...
    FutsalChangjijiPage.prototype.showChangFutsalTues = function () {
        this.checkRegisterStatus();
        this.changFutsalMon_var = false;
        this.changFutsalWed_var = false;
        this.changFutsalThu_var = false;
    ...
    FutsalChangjijiPage.prototype.showChangFutsalWed = function () {
        this.checkRegisterStatus();
        this.changFutsalMon_var = false;
        this.changFutsalTues_var = false;
        this.changFutsalThu_var = false;
    ...
    FutsalChangjijiPage.prototype.showChangFutsalThu = function () {
        this.checkRegisterStatus();
        this.changFutsalMon_var = false;
        this.changFutsalTues_var = false;
        this.changFutsalWed_var = false;
    ...
    FutsalChangjijiPage.prototype.showChangFutsalFri = function () {
        this.checkRegisterStatus();
        this.changFutsalMon_var = false;
        this.changFutsalTues_var = false;
        this.changFutsalWed_var = false;
    ...
    FutsalChangjijiPage.prototype.showChangFutsalSat = function () {
        this.checkRegisterStatus();
        this.changFutsalMon_var = false;
        this.changFutsalTues_var = false;
        this.changFutsalWed_var = false;
    ...
    FutsalChangjijiPage.prototype.showChangFutsalSun = function () {
        this.checkRegisterStatus();
        this.changFutsalMon_var = false;
        this.changFutsalTues_var = false;
        this.changFutsalWed_var = false;
    ...
    FutsalChangjijiPage.prototype.loadFromFirestoreFutsalMonday = function () {
        var _this = this;
        this.fs.collection('/football').doc('changjiji_futsal').collection('/monday').get().subscribe(function (res) {
    ...
    FutsalChangjijiPage.prototype.loadFromFirestoreFutsalTuesday = function () {
        var _this = this;
        this.fs.collection('/football').doc('changjiji_futsal').collection('/tuesday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FutsalChangjijiPage.prototype.loadFromFirestoreFutsalWednesday = function () {
        var _this = this;
        this.fs.collection('/football').doc('changjiji_futsal').collection('/wednesday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FutsalChangjijiPage.prototype.loadFromFirestoreFutsalThursday = function () {
        var _this = this;
        this.fs.collection('/football').doc('changjiji_futsal').collection('/thursday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FutsalChangjijiPage.prototype.loadFromFirestoreFutsalFriday = function () {
        var _this = this;
        this.fs.collection('/football').doc('changjiji_futsal').collection('/friday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FutsalChangjijiPage.prototype.loadFromFirestoreFutsalSaturday = function () {
        var _this = this;
        this.fs.collection('/football').doc('changjiji_futsal').collection('/saturday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FutsalChangjijiPage.prototype.loadFromFirestoreFutsalSunday = function () {
        var _this = this;
        this.fs.collection('/football').doc('changjiji_futsal').collection('/sunday').get().subscribe(function (res) {
            res.forEach(function (doc) {
    ...
    FutsalChangjijiPage.prototype.loadPriceDetail = function () {
        var _this = this;
        this.fs.collection('/football').doc('changjiji_futsal').get().subscribe(function (res) {
    ...
    FutsalChangjijiPage.prototype.callChang = function () {
        this.callNumber.callNumber(this.contact_no.toString(), true);
    };
    FutsalChangjijiPage.prototype.checkRegisterStatus = function () {
        console.log("Here ");
    ...
    FutsalChangjijiPage.prototype.presentAlert = function () {
    ...
    FutsalChangjijiPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-futsal-changjiji',
            template: __webpack_require__(/*! ./futsal-changjiji.page.html */ "./src/app/futsal-changjiji/futsal-changjiji.page.html"),
            styles: [__webpack_require__(/*! ./futsal-changjiji.page.scss */ "./src/app/futsal-changjiji/futsal-changjiji.page.scss")],
        }),
...
//# sourceMappingURL=futsal-changjiji-futsal-changjiji-module.js.map