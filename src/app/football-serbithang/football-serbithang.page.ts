...
@Component({
  ...
  templateUrl: './football-serbithang.page.html',
  styleUrls: ['./football-serbithang.page.scss'],
})
export class FootballSerbithangPage implements OnInit {
  ...
  loadFromFirestoreMonday(){
    this.fs.collection('/football').doc('serbithang').collection('/monday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadFromFirestoreTuesday(){
    this.fs.collection('/football').doc('serbithang').collection('/tuesday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
    ...
    loadFromFirestoreWednesday(){
      this.fs.collection('/football').doc('serbithang').collection('/wednesday').get().subscribe(res=>  
        {
          res.forEach((doc:any)=>
        {
    ...
    loadFromFirestoreThursday(){
      this.fs.collection('/football').doc('serbithang').collection('/thursday').get().subscribe(res=>  
        {
          res.forEach((doc:any)=>
        {
      ...
      loadFromFirestoreFriday(){
        this.fs.collection('/football').doc('serbithang').collection('/friday').get().subscribe(res=>  
          {
            res.forEach((doc:any)=>
          {
      ...
      loadFromFirestoreSaturday(){
        this.fs.collection('/football').doc('serbithang').collection('/saturday').get().subscribe(res=>  
          {
            res.forEach((doc:any)=>
          {
      ...
      loadFromFirestoreSunday(){
        this.fs.collection('/football').doc('serbithang').collection('/sunday').get().subscribe(res=>  
          {
            res.forEach((doc:any)=>
          {
  ...
  loadPriceDetail(){
    this.fs.collection('/football').doc('serbithang').get().subscribe(res=>  
      {
