...
@Component({
  ...
  templateUrl: './football-ydf.page.html',
  styleUrls: ['./football-ydf.page.scss'],
})
export class FootballYdfPage implements OnInit {
  ...
  loadFromFirestoreFutsalMonday(){
    this.fs.collection('/football').doc('ydf').collection('/monday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadFromFirestoreFutsalTuesday(){
    this.fs.collection('/football').doc('ydf').collection('/tuesday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadFromFirestoreFutsalWednesday(){
    this.fs.collection('/football').doc('ydf').collection('/wednesday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadFromFirestoreFutsalThursday(){
    this.fs.collection('/football').doc('ydf').collection('/thursday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadFromFirestoreFutsalFriday(){
    this.fs.collection('/football').doc('ydf').collection('/friday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadFromFirestoreFutsalSaturday(){
    this.fs.collection('/football').doc('ydf').collection('/saturday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadFromFirestoreFutsalSunday(){
    this.fs.collection('/football').doc('ydf').collection('/sunday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadPriceDetail(){
    this.fs.collection('/football').doc('ydf').get().subscribe(res=>  
      {
