...
@Component({
  ...
  templateUrl: './football-babesa.page.html',
  styleUrls: ['./football-babesa.page.scss'],
})
export class FootballBabesaPage implements OnInit {
  ...
  loadFromFirestoreFutsalMonday(){
    this.fs.collection('/football').doc('babesa').collection('/monday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadFromFirestoreFutsalTuesday(){
    this.fs.collection('/football').doc('babesa').collection('/tuesday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadFromFirestoreFutsalWednesday(){
    this.fs.collection('/football').doc('babesa').collection('/wednesday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadFromFirestoreFutsalThursday(){
    this.fs.collection('/football').doc('babesa').collection('/thursday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadFromFirestoreFutsalFriday(){
    this.fs.collection('/football').doc('babesa').collection('/friday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadFromFirestoreFutsalSaturday(){
    this.fs.collection('/football').doc('babesa').collection('/saturday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadFromFirestoreFutsalSunday(){
    this.fs.collection('/football').doc('babesa').collection('/sunday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadPriceDetail(){
    this.fs.collection('/football').doc('babesa').get().subscribe(res=>  
      {
