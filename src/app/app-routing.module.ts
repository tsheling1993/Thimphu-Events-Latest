...
const routes: Routes = [
  ...
  { path: 'admin', loadChildren: './admin/admin.module#AdminPageModule',runGuardsAndResolvers:'always' },
  ...
  { path: 'trackgarbagetruck', loadChildren: './trackgarbagetruck/trackgarbagetruck.module#TrackgarbagetruckPageModule',runGuardsAndResolvers:'always'  },
  ...
  { path: 'football-ydf', loadChildren: './football-ydf/football-ydf.module#FootballYdfPageModule' },
  { path: 'football-serbithang', loadChildren: './football-serbithang/football-serbithang.module#FootballSerbithangPageModule' },
  ...
  { path: 'football-babesa', loadChildren: './football-babesa/football-babesa.module#FootballBabesaPageModule' },
